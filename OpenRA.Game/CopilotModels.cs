...
namespace OpenRA
{
	...
	public static class MCPValidator
	{
		...
		static (bool IsValid, MCPError Error) ValidateMoveActorParams(JObject parameters)
		{
			if (parameters == null)
			{
				return (false, new MCPError
		...
		static (bool IsValid, MCPError Error) ValidateAttackParams(JObject parameters)
		{
			if (parameters == null)
			{
				return (false, new MCPError
